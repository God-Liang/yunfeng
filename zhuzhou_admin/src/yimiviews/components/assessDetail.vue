    ...
    <div class="scrollWrap">
      <div class="leaveForm" style="padding: 20px;width: 650px;margin: 0 auto;background-color: #fff;">
        ...
        <div style="margin-bottom: 25px;">
          ...
          <span style="font-weight: normal;font-size: 13px;color: #333;width: 18%;display: inline-block;">住院号：{{leaveForm.inHospNo}}</span>
        </div>
        <div style="margin-bottom: 25px;">
          ...
          <tr>
            ...
            >
              <p style="margin:0pt; orphans:0; text-align:center; widows:0">
                ...
                <el-select style="width: 120px;display:none;" disabled class="inputForm2" v-model="leaveForm.lifePhysical">
          ...
          <tr>
            ...
            >
              <p style="margin:0pt; orphans:0; text-align:center; widows:0">
                ...
                <el-select style="width: 120px;display:none;" disabled class="inputForm2" v-model="leaveForm.activityLevel">
                  <el-option :value="0"></el-option>
                  <el-option :value="1"></el-option>
                  <el-option :value="2"></el-option>
                </el-select>
          ...
          <tr>
            ...
            >
              <p style="margin:0pt; orphans:0; text-align:center; widows:0">
                ...
                <el-select style="width: 120px;display:none;" disabled class="inputForm2" v-model="leaveForm.nauseaVomiting">
                  <el-option :value="0"></el-option>
                  <el-option :value="1"></el-option>
                  <el-option :value="2"></el-option>
                </el-select>
          ...
          <tr>
            ...
            >
              <p style="margin:0pt; orphans:0; text-align:center; widows:0">
                ...
                <el-select style="width: 120px;display:none;" disabled class="inputForm2" v-model="leaveForm.pain">
                  <el-option :value="0"></el-option>
                  <el-option :value="1"></el-option>
                  <el-option :value="2"></el-option>
                </el-select>
          ...
          <tr>
            ...
            >
              <p style="margin:0pt; orphans:0; text-align:center; widows:0">
                ...
                <el-select style="width: 120px;display:none;" disabled class="inputForm2" v-model="leaveForm.surgicalBleeding">
                  <el-option :value="0"></el-option>
                  <el-option :value="1"></el-option>
                  <el-option :value="2"></el-option>
                </el-select>
...
<script>
  import { readDetail } from '@/api/patientManage/hospitalAssessment'
  export default {
