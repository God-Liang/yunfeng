  ...
  <div class="infomationCheck">
    <div slot="footer" class="dialog-footer clearfix">
      ...
      <div style="float: right;">
        <el-button type="warning" class="buttonRadius saveColor" @click="submitForm('dialogLeftTop1_3_data',0)">保存</el-button>
    ...
    <div class="scrollWrap" ref="scrollWrap">
      ...
      <div class="dataCheckBox margin20">
        <div class="box">
          <h3>资料核对</h3>
          <data-check :dataList="dialogLeftTop1_3_data.dataList"></data-check>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    submitForm(formName, type) {
      ...
      this.$confirm('总共' + AllcheckLength + '项，已核对' + checkedLength + '项，还有' + (AllcheckLength - checkedLength) + '项未核对，确定' + (type === 0 ? '保存' : '提交') + '吗？', '提示', {
    ...
    cancel() {
      this.$store.commit('SET_SECONDARYJUMP', '/optReady/check')
      this.$root.closeTag()
    },
    setAppMainHeight() {
