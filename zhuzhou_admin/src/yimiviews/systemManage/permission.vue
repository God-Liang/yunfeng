      ...
      <div class="flexWrap">
        <div class="leftWrap">
          ...
          <complexTable
            ...
            :list = 'list'
            :totalList = 'total'
            :theadList = "permissionConst.theadList1"
            :operationButtons = 'permissionConst.operationButtons1'
            :statusArr = 'permissionConst.statusArr'
        ...
        <el-dialog  :title="dialogLeftTop1_1_title" :visible.sync="dialogLeftTop1_1" class='dialogLeftTop1_1'>
            <el-form ref="formLeftTop1" :model="formLeftTop1" :inline="true"  label-width="80px">
                <el-form-item label="所属系统">
                    <el-input v-model ='formLeftTop1.systemId' style= 'width: 196px;'></el-input>
                </el-form-item>

                <el-form-item label="父级ID">
                    <el-input v-model ='formLeftTop1.parentId' style= 'width: 196px;'></el-input>
                </el-form-item>
                <el-form-item label="名称">
                  <el-input v-model ='formLeftTop1.name' style= 'width: 196px;'></el-input>
                </el-form-item>
                <el-form-item label="权限编码">
                  <el-input v-model ='formLeftTop1.permissionValue' style= 'width: 196px;'></el-input>
                </el-form-item>
                <el-form-item label="类型">
                <dict-select v-model="formLeftTop1.type" placeholder="请选择" style= 'width: 196px;' dict-code="zylb">
                </dict-select>
                </el-form-item>
...
<script>
    ...
    import { permissionConst } from '@/yimiviews/systemManage/columnsConst'
    import { getList, save, remove, update } from '@/api/systemManage/permission'
