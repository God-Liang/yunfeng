      ...
      <div class="flexWrap">
        <div class="leftWrap">
          ...
          <complexTable
            ...
            :list = 'list'
            :totalList = 'total'
            :theadList = "dicConst.theadList1"
            :operationButtons = 'dicConst.operationButtons1'
            :statusArr = 'dicConst.statusArr'
        ...
        <el-dialog  :title="dialogLeftTop1_1_title" :visible.sync="dialogLeftTop1_1" class='dialogLeftTop1_1'>
            <el-form ref="formLeftTop1" :model="formLeftTop1" :inline="true"  label-width="80px">
                ...
                <el-select v-model="formLeftTop1.departId" placeholder="请选择科室" style= 'width: 196px;'>
                    <el-option v-for = 'item in dicConst.departmentArr' :label="item.label" :value="item.value" :key = 'item.value'></el-option>
                </el-select>
                </el-form-item>
...
<script>
    ...
    import { dicConst } from '@/yimiviews/systemManage/columnsConst'
    import { getList, save, remove, update } from '@/api/systemManage/dic'
    ...
    export default {
      directives: { waves },
      components: { DictSelect, complexTable, category },
      mounted() {
        this.handleFilter()
      },
      data() {
