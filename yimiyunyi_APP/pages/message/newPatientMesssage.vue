<template>
	<view class="lg-container">
		<uni-nav-bar left-icon="back" title="你有新的患者" @clickLeft="onLeftTap"></uni-nav-bar>
		<view class="message-container">
			<mescroll-uni ref="mescrollRef" :height="height" @init="mescrollInit" :down="downOption" @down="downCallback" :up="upOption">
				...
				<view class="message_item" v-for="(item, index) in dataList" :key="index" @tap="onJump('/pages/followUp/patientDetails?patientId='+item.parameter)">
