(function(){
	...
	let utils = {
		...
		ajax: function(options){
			...
			console.log("uni.request", options.url);
			uni.request({
				url: options.url,
				data: options.data,
				...
				success: function(res){
					console.log("uni.request.success", arguments);
				...
				complete:(e)=>{
					console.log("uni.request.complete", arguments);
				},
				fail: (e)=>{
					console.log("uni.request.fail", arguments);
				}
			});
		},
