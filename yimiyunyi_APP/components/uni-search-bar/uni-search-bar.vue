	...
	<view class="uni-searchbar">
		<view :style="{borderRadius:radius+'px',backgroundColor: bgColor}" class="uni-searchbar__box" @click="searchClick">
			...
			<view class="uni-searchbar__box-icon-search">
				<image class="searchImg" v-if="image" :src="image" mode=""></image>
				<uni-icons v-else color="#999999" size="18" type="search" />
			</view>
			<!-- #endif -->
			<!-- #ifndef MP-ALIPAY -->
			<image class="searchImg" v-if="image" :src="image" mode=""></image>
...
<script>
	...
	export default {
		...
		props: {
			...
			image: {
				type: String,
				default: "https://gitee.com/picture_storage_area/follow_up_doctor/raw/master/images/message/search.png"
			}
		},
		data() {
			return {
