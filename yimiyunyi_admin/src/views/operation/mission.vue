<template lang="pug">
  .lg-container
    .lg-container-white
      ...
      lgSelectGroup(:selectData="missionConst.statusArr" :value="filters.status" title="状态：" @click="clickStatus")
      ...
      lgTable(columns-type="index"
            ...
            :list="list"
            :total-list="total"
            :lg-thead="missionConst.tableAttr.thead"
            :lg-buttons="missionConst.tableAttr.buttons"
