<template lang="pug">
  .lg-container
    .lg-container-white
      ...
      lgSelectGroup(:selectData="scaleConst.statusArr" :value="filters.status" title="状态：" @click="clickStatus")
      ...
      .lg-tabel-container
        el-table(key="0"
          ...
          el-table-column(label="量表名称" align="left" width="200" prop="name")
