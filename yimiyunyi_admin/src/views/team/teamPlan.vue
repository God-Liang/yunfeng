<template lang="pug">
  .lg-container
    .lg-container-white
      ...
      lgSelectGroup(:selectData="teamPlanConst.statusArr" :value="filters.status" title="状态：" @click="clickStatus")
      ...
      .lg-tabel-container
        el-table(key="0"
          ...
          el-table-column(v-for="thead in teamPlanConst.tableAttr.thead" :key="thead.label" :width="thead.width || ''" :prop="thead.label" :label="thead.text" :fixed="thead.fixed" class-name="status-col")
...
import { teamPlanConst } from './columnsConst'
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      dataObj.solution.scope = 1
      dataObj.solution.scopeShow = '团队'
