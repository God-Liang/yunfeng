    ...
    >
      <template slot="form">
        ...
        <el-form-item label="性别">
          <el-select v-model="templateForm.sex" class="filter-item" placeholder="Please select">
            <el-option
  ...
  data() {
    return {
      ...
      tableAttr: {
        // 表头
        thead: [
          { label: 'weChatNick', text: ' 微信昵称 ' },
          { label: 'weChatImg', text: ' 微信头像 ' },
          { label: 'weChatOpenId', text: ' 微信openId ' },
          { label: 'name', text: ' 登录名 ' },
          { label: 'realName', text: ' 真实姓名 ' },
          { label: 'phone', text: ' 电话 ' },
          { label: 'status', text: ' 用户状态' },
          { label: 'statusShow', text: ' 状态值 ' },
          { label: 'sex', text: '性别' },
          { label: 'sexShow', text: ' 性别值 ' },
          { label: 'emall', text: ' 邮箱 ' },
          { label: 'password', text: ' 密码 ' },
          { label: 'addressIds', text: ' 地址id集合，逗号隔开 ' }
        ],
        // 操作按钮
        buttons: {
