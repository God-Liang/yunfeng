<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      >
        <el-option
          v-for="item in mySupplierConst.statusOptions"
          :key="item.value"
          :label="item.label"
          :value="item.value"
        />
      ...
      >
        <el-option
          v-for="item in mySupplierConst.payOptions"
          :key="item.value"
          :label="item.label"
          :value="item.value"
        />
    ...
    <lgTable
      ...
      :list="list"
      :total-list="total"
      :lg-thead="mySupplierConst.tableAttr.thead"
      :lg-buttons="mySupplierConst.tableAttr.buttons"
    ...
    >
      <template>
        <!--搜索模块-->
        <div class="filter-container">
          <lgSite v-model="clientData['input.area']" class="filter-item" />
          <el-input
        ...
        <div class="clientBox">
          <el-table :data="clientList" :show-header="false" border>
            <el-table-column prop="date" width="460">
              <template slot-scope="scope">
                <div class="client-container">
                  <img class src="@/assets/clientImg.png" alt>
                  <div class="clientInfo">
                    <router-link
                      :to="`/details/customerDetail/${scope.row.Id}/false`"
            ...
            <el-table-column prop="name" align="center">
              <template slot-scope="scope">
                <el-button type="primary" size="small" @click="handleClientApply(scope.row)">申请</el-button>
              </template>
            </el-table-column>
          </el-table>
        </div>
...
import { mySupplierConst } from '@/views/contacts/columnsConst'
